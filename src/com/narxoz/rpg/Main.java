...
public class Main {
    public static void main(String[] args) {
        ...
        ArenaFighter hero = new ArenaFighter("Arlan", 100, 0.20, 25, 5, 18, 3);
        ...
        System.out.println("Opponent HP: " + opponent.getHealth());
        System.out.println("Hero dodge chance: " + hero.getDodgeChance());
